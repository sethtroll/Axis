...
public class CombatUtilities {
    ...
    public static double applyCombatPrecision(Player player, double accuracy) {
        final Perk focus = player.getPerkManager().get(PerkWrapper.COMBAT_PRECISION);
        if (focus != null && focus.valid()) {
            accuracy += focus.getEffect();
