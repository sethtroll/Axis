...
public final class DarkBowRangedCombat extends RangedCombat {
    ...
    public int processWithDelay() {
        ...
        if (echo != null && echo.valid() && target instanceof NPC && Utils.randomDouble() < echo.getEffect()) {
            ...
            delayHit(secondArrowDelay, echoHit);
        }
    ...
    private enum Arrow {
        ...
        Arrow(final AmmunitionDefinitions definitions, final Graphics drawback, final Projectile firstProjectile, final Projectile secondProjectile) {
