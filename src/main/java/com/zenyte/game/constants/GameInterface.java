...
public enum GameInterface {
    ...
    GRAND_EXCHANGE_OFFERS_VIEWER(10014),
    ...
    DAILY_CHALLENGES_OVERVIEW(10001),
    ...
    TELEPORT_MENU(10009),
    RELIC(10015),
    GAME_NOTICEBOARD(10005, InterfacePosition.ACCOUNT_MANAGEMENT),
    ...
    HAIRDRESSER(82),
    COLLECTION_LOG(621),
    SPELLBOOK(Edenify.INTERFACES.offsetted(218), SPELLBOOK_TAB),
    ...
    DUEL_WINNINGS(108),
    DUEL_STAKING(481),
    DUEL_STAKING_INVENTORY(1617, SINGLE_TAB),
    DUEL_SETTINGS(482),
    DUEL_CONFIRMATION(476),
    DUEL_SCOREBOARD(108),
    CHAT(162, CHATBOX),
    ITEMS_KEPT_ON_DEATH(4),
    GRAVESTONE_RECLAIM(672, InterfacePosition.WORLD_MAP),
    ...
    CHARACTER_SUMMARY_TAB(712, InterfacePosition.JOURNAL_TAB_HEADER),
    LEAGUES_TAB(656, InterfacePosition.JOURNAL_TAB_HEADER),
    ...
    EXPERIENCE_MODE_SELECTION(1703),
