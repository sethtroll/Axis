...
import com.zenyte.game.model.ui.chat_channel.ChatChannelPlayerExtKt;
...
import static com.zenyte.game.constants.GameInterface.TELEPORT_MENU;
...
public class InterfaceHandler {
    private static final int[] EXPANDED_INTERFACES = new int[] {12, 139, 400, 345, 310, 700, 1704, 1709, 675, 724, 1614, 2000};
    ...
    @Ordinal
    public enum Journal {
        CHARACTER_SUMMARY, QUEST_TAB, ACHIEVEMENT_DIARIES, KOUREND, ADVENTURE_PATHS, LEAGUES
    }
    ...
    public void openJournal() {
        ...
        switch (journal) {
            ...
            case CHARACTER_SUMMARY:
                GameInterface.CHARACTER_SUMMARY_TAB.open(player);
                break;
            case KOUREND:
                GameInterface.KOUREND_FAVOUR_TAB.open(player);
                break;
            case LEAGUES:
                GameInterface.LEAGUES_TAB.open(player);
                break;
        }
    }
