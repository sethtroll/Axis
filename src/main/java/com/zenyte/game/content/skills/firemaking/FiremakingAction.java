...
public class FiremakingAction extends Action {
    ...
    public FiremakingAction(final Firemaking data, final int slot, final boolean floor, final FiremakingTool tool, final Optional<FloorItem> floorItem) {
        this.data = data;
        this.slot = slot;
        this.floor = floor;
        this.tool = tool;
    ...
    private boolean check() {
        ...
        if (player.getSkills().getLevel(Skills.FIREMAKING) < data.getLevel()) {
    ...
    public boolean start() {
        ...
        final int levelDifference = player.getSkills().getLevel(Skills.FIREMAKING) - data.getLevel();
    ...
    private void light() {
        ...
        final WorldObject object = new WorldObject(data.getObjectId(), 10, 1, location);
        ...
        player.getSkills().addXp(Skills.FIREMAKING, data.getXp());
