...
public final class KingBlackDragon extends NPC implements Spawnable, CombatScript {
    ...
    public int attack(final Entity target) {
        ...
        if (random == 0) {
            ...
            delayHit(npc, DRAGONFIRE_PROJ.getTime(npc, target), target, new Hit(npc, Utils.random(Math.max(0, dragonfire.getDamage())), HitType.REGULAR).onLand(hit -> {
            ...
            switch (atk) {
                case 0: {
                    ...
                    delayHit(npc, POISON_PROJ.getTime(npc, target), target, new Hit(npc, Utils.random(Math.max(0, dragonfire.getDamage())), HitType.REGULAR).onLand(hit -> {
                ...
                case 1: {
                    ...
                    delayHit(npc, FREEZING_PROJ.getTime(npc, target), target, new Hit(npc, Utils.random(Math.max(0, dragonfire.getDamage())), HitType.REGULAR).onLand(hit -> {
                ...
                case 2: {
                    ...
                    delayHit(npc, SHOCKING_PROJ.getTime(npc, target), target, new Hit(npc, Utils.random(Math.max(0, dragonfire.getDamage())), HitType.REGULAR).onLand(hit -> {
