...
public final class CoresManager {
    private static final org.slf4j.Logger log = LoggerFactory.getLogger(CoresManager.class);
    private static final Logger logger = LoggerFactory.getLogger(CoresManager.class);
    ...
    public static void init() {
        ...
        /** Disable Discord for now
        if (Constants.DISCORD_ENABLED) {
            discordThread.start();
        }
         */
    }
