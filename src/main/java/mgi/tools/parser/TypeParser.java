...
public class TypeParser {
    ...
    private static String folderToPullFrom = "assets";
    ...
    public static void main(final String[] args) throws IOException {
        ...
        initializeKryo();
        parse(new File(folderToPullFrom + "/types"));
        ...
        try {
            for (final java.io.File file : folder.listFiles()) {
                ...
                if (file.isDirectory()) {
                    ...
                    if (file.getPath().startsWith(Paths.get(folderToPullFrom, "types", "component").toString())) {
    ...
    private static void packClientBackground() throws IOException {
        if (true)
            return;
        final byte[] desktop = java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/sprites/background" + "/background_desktop.png"));
        ...
        final BufferedImage image = ImageIO.read(Paths.get(folderToPullFrom + "/sprites/background/background_logo" + ".png").toFile());
    ...
    private static void packModels() {
        try {
            packModel(52539, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/custom/model_51795.dat")));
            packModel(52517, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/starter/Starter bow ground.dat")));
            packModel(52518, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/starter/Starter bow.dat")));
            packModel(52519, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/starter/Starter staff ground.dat")));
            packModel(52520, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/starter/Starter staff.dat")));
            packModel(52521, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/starter/Starter sword ground.dat")));
            packModel(52522, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/starter/Starter sword.dat")));
            packModel(38000, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/zenyte_portal_model.dat")));
            packModel(38001, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/tournament_supplies.dat")));
            packModel(38002, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/pets/cute_creature.dat")));
            packModel(38003, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/pets/stray_dog.dat")));
            packModel(38004, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/pets/evil_creature.dat")));
            packModel(38005, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/bonds/cyan_bond.dat")));
            packModel(38006, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/bonds/red_bond.dat")));
            packModel(50000, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/zenyte_teletab_50000.dat")));
            packModel(50000, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/Pharaoh_teletab_50000 old.dat")));
            packModel(50001, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/healing fountain.dat")));
            packModel(52506, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/zenyte armour/Pharaoh Bootsb.dat")));
            packModel(52507, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/zenyte armour/Pharaoh Cape(drop)b.dat")));
            packModel(52508, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/zenyte armour/Pharaoh Capeb.dat")));
            packModel(52509, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/zenyte armour/Pharaoh Gloves(drop)b.dat")));
            packModel(52510, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/zenyte armour/Pharaoh Glovesb.dat")));
            packModel(52511, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/zenyte armour/Pharaoh Helmet(drop)b.dat")));
            packModel(52512, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/zenyte armour/Pharaoh Helmetb.dat")));
            packModel(52513, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/zenyte armour/Pharaoh Platebody(drop)b.dat")));
            packModel(52514, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/zenyte armour/Pharaoh Platebodyb.dat")));
            packModel(52515, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/zenyte armour/Pharaoh Platelegs(drop)b.dat")));
            packModel(52516, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/zenyte armour/Pharaoh Platelegsb.dat")));

            packModel(52523, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/Rare drop table.dat")));

            //custom
            packModel(52535, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/custom/model_51732.dat")));
            packModel(52536, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/custom/model_51733.dat")));
            packModel(52537, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/custom/model_51753.dat")));
            packModel(52538, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/custom/model_51754.dat")));
            packModel(52539, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/custom/model_51795.dat")));
            packModel(52540, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/custom/model_51796.dat")));
            packModel(52541, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/custom/model_51797.dat")));

            //Well of goodwill
            packModel(50769, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/wellofgoodwill/10460.dat")));

            //Jonas
            packModel(52524, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/halloween/staticmodels/jonas/34041.dat")));
            packModel(52525, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/halloween/staticmodels/jonas/34044.dat")));
            packModel(52526, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/halloween/staticmodels/jonas/34046.dat")));
            packModel(52527, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/halloween/staticmodels/jonas/34047.dat")));
            //Grim reaper
            packModel(52528, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/halloween/staticmodels/grim reaper/28985.dat")));
            packModel(52529, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/halloween/staticmodels/grim reaper/34166.dat")));
            packModel(52530, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/halloween/staticmodels/grim reaper/34167.dat")));
            //Thanksgiving
            packModel(52531, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/thanksgiving/thanksgiving turkey model.dat")));
            packModel(52532, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/thanksgiving/thanksgiving poof model.dat")));
            //Christmas scythe
            packModel(52533, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/christmas scythe inv.dat")));
            packModel(52534, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "models/christmas scythe wield.dat")));
            packModel(2450, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/Treasure trails reward casket.dat")));
            if (Constants.CHRISTMAS) {
                Iterator<File> it = FileUtils.iterateFiles(new File(folderToPullFrom + "/christmas/christmas-y entities models/"), null, false);
            ...
            //Scroll boxes
            packModel(53000, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/scroll boxes/39028.dat")));
            packModel(53001, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/scroll boxes/39029.dat")));
            packModel(53002, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/scroll boxes/39030.dat")));
            packModel(53003, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/scroll boxes/39031.dat")));
            packModel(53004, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/scroll boxes/39032.dat")));
            packModel(53005, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/scroll boxes/39033.dat")));
            packModel(57577, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/clue progresser/1.dat")));
            packModel(57578, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/clue progresser/2.dat")));
            packModel(57579, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/clue progresser/3.dat")));
            packModel(57580, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/clue progresser/4.dat")));
            packModel(57581, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/models/clue progresser/5.dat")));
            TypeParser.packModel(57576, org.apache.commons.compress.utils.IOUtils.toByteArray(new FileInputStream(new File(folderToPullFrom + "/dice bag/item_model.dat"))));
        } catch (IOException e) {
            log.error("", e);
        }
    }
    ...
    private static void packClientScripts() throws IOException {
        ...
        var files = Paths.get(folderToPullFrom + "/cs2/old_jagex/").toFile().listFiles();
        for (var file : files) {
            var id = Integer.parseInt(file.getName().replaceAll(".cs2", ""));
            packClientScript(id, java.nio.file.Files.readAllBytes(file.toPath()));
        }
        packClientScript(393, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/cs2/skill_tab_construction/393.cs2")));
        ...
        packClientScript(1261, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/cs2/tourny_fog/1261.cs2")));
        packClientScript(1705, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/cs2/edgeville_map_link/1705.cs2")));
        ...
        packClientScript(2186, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/cs2/tourny_viewer/2186.cs2")));
        ...
        for (int id = 20585; id <= 20588; id++) {
            packClientScript(id, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/cs2/game_noticeboard/" + id)));
        }
        for (int id = 20000; id <= 20015; id++) {
            packClientScript(id, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/cs2/teleport_menu/" + id)));
        }
        packClientScript(10100, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/cs2/ironman_setup/10100.cs2")));
        for (int i = 10034; i <= 10048; i++) {
            packClientScript(i, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/cs2/wheel_of_fortune/" + i + ".cs2")));
        }
        for (int id = 10102; id <= 10121; id++) {
            packClientScript(id, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/cs2/drop_viewer/" + id + ".cs2")));
        }
        for (int id = 10200; id <= 10202; id++) {
            packClientScript(id, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/cs2/game_settings/" + id + ".cs2")));
        }
        for (int id = 20300; id <= 20306; id++) {
            packClientScript(id, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/cs2/daily_challenges/" + id)));
        }
        for (int id = 10400; id <= 10405; id++) {
            packClientScript(id, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/cs2/tourny_info/" + id + ".cs2")));
        }
        ...
        packClientScript(10600, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/cs2/tourny_viewer/10600.cs2")));
        packClientScript(10700, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/cs2/hide_roofs/10700.cs2")));
        for (var file : Objects.requireNonNull(new File(folderToPullFrom + "/cs2/ge_offers/").listFiles())) {
            if (!file.isFile())
                continue;
            var id = Integer.parseInt(file.getName());
            packClientScript(id, Files.toByteArray(file));
        }
        packClientScript(336, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/cs2/godwars_dungeon/336.cs2")));
        packClientScript(342, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/cs2/godwars_dungeon/342.cs2")));
        for (int i = 10900; i <= 10912; i++) {
            packClientScript(i, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/cs2/eco_presets/" + i + ".cs2")));
        }
        packClientScript(1311, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/cs2/tog_sidepanel_timer.cs2")));
        packRustyScripts(folderToPullFrom + "/scripts/out/");
        for (File file : new File(folderToPullFrom + "/cs2/custom").listFiles()) {
            if (!file.isFile())
                continue;
    ...
    private static void packInterfaces() throws IOException {
        final Cache cache = Game.getCacheMgi();
        packInterfacesInner(cache, Paths.get(folderToPullFrom + "/interfaces").toFile().listFiles());
    }
    ...
    private static void packMaps() throws IOException {
        packMapPre209(9261, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/island_l_regular.dat")), MapUtils.inject(java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/island_m_regular.dat")), o -> {
            if (o.getId() == 46087) {
                o.setId(46089);
            }
            return false;
        }));
        packMapPre209(10388, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/yanille/328.dat")), java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/yanille/329.dat")));
        ...
        packMapPre209(7490, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/Donor.dat")), MapUtils.inject(java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/Donor1.dat")),
                o -> {
                    if (o.getId() == 46087) {
                        o.setId(46089);
                    }
        ...
        packMapPre209(10569, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/startarea.dat")), MapUtils.inject(java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/startarea1.dat")),
                o -> {
                    if (o.getId() == 46087) {
                        o.setId(46089);
                    }
        ...
        if (PACK_ZENYTE_HOME) {
            packMapPre209(12342, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/home28_l.dat")), MapUtils.inject(java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/home28_m.dat")), o -> {
                        if (o.getId() == 46087) {
                            o.setId(46089);
                    ...
                    new WorldObject(40848, 10, 2, new Location(3265, 6078, 0)),//Box of Restoration
                    new WorldObject(41415, 10, 2, new Location(3264, 6082, 0)),//Portal Nexus
        ...
        packMapPre209(14477, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/dmm_tourny/m56_141.dat")), java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/dmm_tourny/l56_141.dat")));
        packMapPre209(14478, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/dmm_tourny/m56_142.dat")), java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/dmm_tourny/l56_142.dat")));
        packMapPre209(14733, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/dmm_tourny/m57_141.dat")), java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/dmm_tourny/l57_141.dat")));
        packMapPre209(14734, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/dmm_tourny/m57_142.dat")), java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/dmm_tourny/l57_142.dat")));
        packMapPre209(15245, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/tournament/2.dat")), java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/tournament/3.dat")));
        packMapPre209(15248, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/tournament/0.dat")), MapUtils.inject(java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/tournament/1.dat")), null, new WorldObject(35005, 10, 3, new Location(3806, 9245, 0)), new WorldObject(35006, 10, 1, new Location(3813, 9256, 0)), new WorldObject(35007, 10, 0, new Location(3799, 9256, 0))));
        ...
        packMapPre209(4674, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/godwars-instances/Armadyl/0.dat")), MapUtils.inject(java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/godwars-instances/Armadyl/1.dat")), o -> {
        ...
        packMapPre209(4675, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/godwars-instances/Bandos/0.dat")), MapUtils.inject(java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/godwars-instances/Bandos/1.dat")), o -> {
        ...
        packMapPre209(4676, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/godwars-instances/Zamorak/0.dat")), MapUtils.inject(java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/godwars-instances/Zamorak/1.dat")), o -> {
        ...
        packMapPre209(4677, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/godwars-instances/Saradomin/0.dat")), MapUtils.inject(java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/godwars-instances/Saradomin/1.dat")), o -> {
        ...
        packMapPre209(11346, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/godwars-instances/Armadyl/1858.dat")), MapUtils.inject(java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/godwars-instances/Armadyl/1859.dat")), o -> {
            if (o.getId() == ObjectId.EXIT_PORTAL_20843) {
                o.setId(35016);
            } else if (o.getId() == ObjectId.CREVICE_26769) {
                o.setId(35013);
        ...
        packMapPre209(11347, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/godwars-instances/Bandos/1860.dat")), MapUtils.inject(java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/godwars-instances/Bandos/1861.dat")), o -> {
            if (o.getId() == ObjectId.PRIVATE_PORTAL) {
                o.setId(35014);
            } else if (o.getId() == ObjectId.CREVICE_26769) {
                o.setId(35013);
        ...
        packMapPre209(11602, java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/godwars-instances/Saradomin/1862.dat")), MapUtils.inject(java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/godwars-instances/Saradomin/1863.dat")), o -> {
            if (o.getId() == ObjectId.PORTAL_26740) {
                o.setId(35017);
            } else if (o.getId() == ObjectId.STEPPING_STONE_21120) {
                o.setId(35018);
        ...
        packMapPre209(11603, MapUtils.processTiles(new ByteBuffer(java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/godwars-instances/Zamorak/1856.dat"))), tile -> {
        ...
        }).getBuffer(), MapUtils.inject(java.nio.file.Files.readAllBytes(Paths.get(folderToPullFrom + "/map/godwars-instances/Zamorak/1857.dat")), o -> {
            if (o.getId() == ObjectId.PORTAL_34752) {
                o.setId(35015);
            } else if (o.getId() == ObjectId.CREVICE_26769) {
                o.setId(35013);
    ...
    public static void packInvs() throws IOException {
        for (File file : Paths.get(folderToPullFrom + "/inv").toFile().listFiles()) {
    ...
    public static void packEnums() throws IOException {
        for (File file : Paths.get(folderToPullFrom + "/enum").toFile().listFiles()) {
            if (!file.getName().contains(".")) {
                try {
                    final int id = Integer.parseInt(file.getName());
    ...
    public static void packStructs() throws IOException {
        for (File file : Paths.get(folderToPullFrom + "/structs").toFile().listFiles()) {
            if (!file.getName().contains(".")) {
                try {
                    final int id = Integer.parseInt(file.getName());
    ...
    public static void packParams() throws IOException {
        for (File file : Paths.get(folderToPullFrom + "/params").toFile().listFiles()) {
            if (!file.getName().contains(".")) {
                try {
                    final int id = Integer.parseInt(file.getName());
